      ...
      <div className="grid lg:grid-cols-2 gap-16 items-center">
        <div className="space-y-8">
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            {values.map((v, i) => (
              <div key={i} className="p-6 bg-white rounded-[2rem] shadow-xl border-2 border-purple-50 hover:shadow-2xl hover:scale-105 transition-all duration-300">
                <div className="mb-4">{v.icon}</div>
                <h4 className="text-lg font-black text-gray-800 mb-1">{v.title}</h4>
                <p className="text-sm text-gray-500 font-bold">{v.text}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-6">
          <img src="https://picsum.photos/seed/about1/500/600" className="rounded-[2.5rem] shadow-2xl mt-8 border-8 border-white transform -rotate-3 hover:rotate-0 transition-transform duration-500" alt="Study" />
          <img src="https://picsum.photos/seed/about2/500/600" className="rounded-[2.5rem] shadow-2xl border-8 border-white transform rotate-3 hover:rotate-0 transition-transform duration-500" alt="Study 2" />
        </div>
      </div>
    </div>
  );
